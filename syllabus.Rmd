...
*Office:* TBD  
*Email:* [jeremy.morris@utah.edu](mailto:jeremy.morris@utah.edu){.email}  
*Phone:* 801-573-3265  
*Twitter:* @seedatarun

*Teaching Assistant:* Jonathan Rossi  
*Email:* [u0958682@utah.edu](mailto:u0958682@utah.edu){.email}  

Start Date: August 23, 2022  
Classroom: Online  

Office hours can be scheduled by [clicking here](https://outlook.office365.com/owa/calendar/StudentOfficeHours@precision-analytics.io/bookings/).

This syllabus is subject to change.
Please come back and review occasionally to see changes.
...
All materials for the course can be found on GitHub here: <https://github.com/is6481>.
Students are expected to keep up with all other materials and announcements in Canvas.

### Weekly Webinar

I will host a webinar every Tuesday during the session from 5:00 to 5:45 pm.
Recorded sessions will be available in Canvas in the Media Gallery.
Meeting info below.
...
Lecture notes and quiz study guides can be found on GitHub at the following locations.

-   [All Lecture Notes](https://github.com/is6481/lecture_slides_notes)
-   [Quiz Study Guides](https://github.com/is6481/lecture_slides_notes/tree/master/quiz_study_guides)

### Course Description

Data has always been used as a way to measure and improve processes in business.
At its core, this course intends to teach best practices for optimizing business processes using data.
...
This course also includes a set of hands-on labs intended to walk students through the process of providing analytics to a business.
The intent is not to get any deep skills in one particular area but to introduce students to various technologies and to gain a small amount of hands-on experience with those technologies.
A very small amount of coding will be required, help will be provided when necessary.
This semester we will be using the following technologies (in some form or another).
...
Rather, they reflect the most common misconceptions that students have with respect to academic misconduct: Never share a file with another student.
If two or more students collaborate on an effort, the outputs should either be: Allocated to a single student.
All other students must reproduce the outputs independently.
Destroyed.
All students must reproduce the outputs independently.
When helping another student, never show them your solution.
Consider, working on their computer/whiteboard/paper instead.
...
If a submission is not indicated as "group-based", assume that you need to complete the submission independently.
If group/independent nature of a submission is unclear, check with the instructor before making the assumption.
...
The typical sanction for a first-time academic misconduct case is a grade of -100% for the submission item.
In addition, your details will be entered into a centralized database so administrators can manage repeat offenders.
